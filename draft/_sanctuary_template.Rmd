...
if (!is.na(d_s$where_question_caption))
  cat(glue("<i class='fas fa-question-circle'></i> {d_s$where_question_caption}\n<br>\n"))

if (!is.na(d_s$where_chart_caption))
  cat(glue("<i class='fas fa-chart-bar'></i> {d_s$where_chart_caption}\n<br>\n"))
```
...
streamplot  <- filter(tbl_measures, file_type == "streamplot")
...
- [Click here](https://sanctsound.ioos.us/draft/q_what-learn.html) 
to learn about our collection of stories. 
- [Click here](https://sanctsound.ioos.us/draft/stories.html) to 
read more SanctSound stories.
