...
params:
  ...
  #svg: "svg/cinms.svg"
  # 1. cmd: inkscape dolphin_PIFSC_BB-AI-unite-simplify.svg -o dolphin_PIFSC_BB-AI-unite-simplify.wmf # rm outline
  # 2. [fknms - Google Drawings](https://docs.google.com/drawings/d/10-2gjxCoxeszyxbujC6Jby5GZ-ppTvC1hblljLEybOA/edit)
  # 3. notice svg: repeat linked shapes <path fill="transparent" fill-opacity="0" d=...
  svg: "https://docs.google.com/drawings/d/10-2gjxCoxeszyxbujC6Jby5GZ-ppTvC1hblljLEybOA/export/svg"
  # "https://docs.google.com/drawings/d/1bdxDXTdjTMUZVlGWtjLdT6QP3m7NwnLF/export/svg"
  # https://drive.google.com/file/d/1bdxDXTdjTMUZVlGWtjLdT6QP3m7NwnLF/view?usp=sharing
  #https://docs.google.com/drawings/d/10-2gjxCoxeszyxbujC6Jby5GZ-ppTvC1hblljLEybOA/edit?usp=sharing
output:
  html_document:
    mathjax: null
...
```{r stories-masonry-old, results='asis', eval=F}
