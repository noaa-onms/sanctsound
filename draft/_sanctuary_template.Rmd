...
with(
  spectrogram,
  figure(
    header  = "**Spectrogram**: _intensity of different pitches over time_",
    img     = img_rel,
    caption = caption, 
    size    = "col-md-12"))
```
...
`r shiny::icon("question-circle")` _Learn more about **[what we measured and how to read and understand these summary graphs](https://sanctsound.ioos.us/draft/q_what-measure.html)**._
...
`r shiny::icon("question-circle")` _Learn about our **[collection of stories](https://sanctsound.ioos.us/draft/q_what-learn.html)**._

`r shiny::icon("newspaper-o")` _Read more **[SanctSound stories](https://sanctsound.ioos.us/draft/stories.html)**. 
._
