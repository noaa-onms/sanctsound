...
```{r, results='asis'}
figure(
  img = "./images/questions/SB01_above-median_04122022_annotated_final.png",
...
## Power spectrum plots: Variability of loudness across pitches
...
```{r, results='asis'}
figure(
  img = "./images/questions/SB01_power-spec_04122022_annotated_final.png",
  caption = "In this example plot for the same listening site at Stellwagen Bank National Marine Sanctuary, low pitched sounds (63-2,500 Hz) had the highest median intensities (black line) compared to other pitches. Across most pitches, sound levels were highly variable (wide gray band) due to weather events, vessel presence, and marine mammal vocal activity.",
  alt = "")
```
...
```{r, results='asis'}
figure(
  img = "./images/questions/SB01_anomaly_04122022_annotated_final.png",
