...
<figure class="cd-image-container">
 ...
 <span class="cd-image-label" data-type="original">Date: 2019</span>
 
 <div class="cd-resize-img"> <!-- the resizable image on top -->
  <img src="./images/questions/Propogation_CI01_1000Hz.png" alt="Modified Image">
	<span class="cd-image-label" data-type="modified">Date: 2009</span>
 </div>
	<span class="cd-handle"></span>
	#Ben I think this is going to break your code - just trying to add a figure caption under the slider thing but don't have a template to follow with this new figure class.
	#<img caption="Comparison of listening ranges at the same recording location in the Channel Islands National Marine Sanctuary in winter conditions for two different sources of sound: a very low frequency and loud sound (slide left) and a moderately loud and moderately low frequency sound (slide right).">
</figure>
